...
file_dir="D:/论文数据/SPEI指数数据集/penman方程及站点数据计算SPEI不用python包/20每月所有站点SPEI24提取(1981-2020)"
file_to="D:/论文数据/SPEI指数数据集/penman方程及站点数据计算SPEI不用python包/25每月SPEI24指数shp文件"
