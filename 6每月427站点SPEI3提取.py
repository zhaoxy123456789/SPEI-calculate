...
file_dir='D:/论文数据/SPEI指数数据集/penman方程及站点数据计算SPEI不用python包/8SPEI3指数427站点数据提取'
file_to='D:/论文数据/SPEI指数数据集/penman方程及站点数据计算SPEI不用python包/9每月427站点SPEI3提取'
...
for year in years:
    for month in months:
        ...
        for file_csv in all_csv_list:
            ...
            data=data[['Station','Lat','Lon','Altitude','Year','Month','SPEI3']]
        ...
        dataframe=pd.DataFrame(List,columns=['Station','Lat','Lon','Altitude','Year','Month','SPEI_3'])
